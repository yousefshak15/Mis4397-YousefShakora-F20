...
class ConsolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create console" do
    assert_difference('Console.count') do
      post consoles_url, params: { console: { description: @console.description, image: @console.image, name: @console.name } }
    end
  ...
  test "should update console" do
    patch console_url(@console), params: { console: { description: @console.description, image: @console.image, name: @console.name } }
